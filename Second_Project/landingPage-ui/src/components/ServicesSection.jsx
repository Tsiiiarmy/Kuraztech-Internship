...
const ServicesSection = () => {
  return (
    <section className="relative py-50 px-6 md:px-20 bg-white text-center overflow-hidden">
      {/* Decorative Image (Right) */}
      <img
        src={decor}
        alt="Decoration"
        className="hidden md:block absolute right-0 top-30 w-50 h-auto opacity-80 pointer-events-none z-0"
      />
      ...
      <div className="relative z-10">
        ...
        <div className="mb-14">
          ...
          <h2
            className="text-4xl md:text-5xl font-bold text-[#181e4b] mt-3"
